...
var Utils = {
    ...
    codigoCargoAtlas (codigoCargoTse, numTurno) {
        if (!numTurno)
            throw 'Error in codigoCargoAtlas: numTurno is required'
        const codigos = {
            1: 'pr' + numTurno,
            3: 'g' + numTurno,
            5: 's',
        ...
        return codigos[codigoCargoTse]
    },
    
    calcMunZonaId (codTse, numZona) {
        let idZona = ('000' + numZona).substr(-3)
        return codTse + '-' + idZona
    },
